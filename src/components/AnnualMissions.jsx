      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {missions.map((mission) => (
            <div key={mission.id} className="bg-black/70 backdrop-blur-sm rounded-lg p-6 border border-white/10 hover:border-yellow-400/30 transition-colors">
              <div className="mb-4">
              ...
              <h4 className="text-xl font-bold text-white mb-3">{mission.title}</h4>
              <p className="text-gray-300 mb-6">{mission.description}</p>
              
              <div className="space-y-3 mb-6">
                <div className="flex justify-between items-center py-2 border-b border-gray-700">
                  <span className="text-gray-400">Target Amount</span>
                  <span className="text-yellow-400 font-semibold">${mission.target.toLocaleString()}</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-gray-700">
                  <span className="text-gray-400">Timing</span>
                  <span className="text-white">{mission.timing}</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-gray-700">
                  <span className="text-gray-400">Helps</span>
                  <span className="text-white">{mission.helps}</span>
                </div>
              </div>
