      ...
      <div className="bg-black py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
            ...
            <div className="bg-gray-800 p-4 rounded-lg text-center border border-gray-700">
              <div className="text-sm text-gray-400 mb-1">New Chapters</div>
              <div className="text-2xl font-bold text-blue-400">1</div>
            </div>
            <div className="bg-gray-800 p-4 rounded-lg text-center border border-gray-700">
              <div className="text-sm text-gray-400 mb-1">🎂 Birthdays</div>
              <div className="text-2xl font-bold text-pink-400">0</div>
            </div>
            <div className="bg-gray-800 p-4 rounded-lg text-center border border-gray-700">
              <div className="text-sm text-gray-400 mb-1">🎉 Anniversaries</div>
